...
export function HeroSection({ onUploadClick }: HeroSectionProps) {
  ...
  return (
    <div
      className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-900"
    >
      <div
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p
              className="text-base sm:text-lg md:text-xl text-white/40 mb-8 md:mb-12 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4"
            >
          ...
          >
            <Button
              ...
              size="lg"
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-8 py-6 rounded-lg text-lg transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/50"
            >
              Start Analyzing
            </Button>
            <Button
              variant="outline"
              size="lg"
              className="border border-white/20 text-white hover:bg-white/5 font-semibold px-8 py-6 rounded-lg text-lg"
            >
              Learn More
            </Button>
          </motion.div>
